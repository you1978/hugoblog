---
title: "[実録]作業時間１時間で4万円を手に入れた方法"
description: ""
date: "2022-06-10T14:43:24Z"
toc: true
draft: false
share: true
...
つまり、海外のお金と日本のお金を交換することにより為替の違いにより利益や損失を生む取引です。  
  
通常FXはレバレッジと呼ばれる実際に持っているお金の何十倍も取引が可能なことが多いです。レバレッジをかけるとリスクが高くなります。なお、リスクとは儲ける可能性も損をする可能性もどちらも上がるという意味です。  

DMM FXのセルフバックの凄いところは、入金して１ロット以上取引をすると、報酬がもらえるという点です。１ロットというのは1回の取引の最小単位になります。  
大抵の場合は、１ロットが１万単位であることが多いです。  
DMM FXでは、ドルと円の取引において１ロットを取引するのにかかるお金は大体4万円ぐらいの証拠金が必要になります。証拠金とは借金のカタのようなもので損をするとそのカタが取られてしまいます。  
そこでリスクを極限までに減らして１ロット以上取引をする方法としては、円でドルを買った数秒後にドルを円を買えば良いのです。数秒であれば損失が合った場合でも100円程度にすることができます。  
